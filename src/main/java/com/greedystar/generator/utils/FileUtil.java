...
public class FileUtil {
    ...
    private static Template getTemplate(int type) throws IOException {
        switch (type) {
            ...
            case FreemarketConfigUtils.TYPE_VO:
                return FreemarketConfigUtils.getInstance().getTemplate("EntityVo.ftl");
            case FreemarketConfigUtils.TYPE_REQ:
                return FreemarketConfigUtils.getInstance().getTemplate("EntityReq.ftl");
            default:
                return null;
        }
    }
