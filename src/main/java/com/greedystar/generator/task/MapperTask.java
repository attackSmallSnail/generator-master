...
public class MapperTask extends AbstractTask {
    ...
    public void run() throws IOException, TemplateException {
        ...
        mapperData.put("VoPackageName", ConfigUtil.getConfiguration().getPath().getVo());
        mapperData.put("ReqPackageName", ConfigUtil.getConfiguration().getPath().getReq());
        ...
        mapperData.put("PrimaryKey", getPrimaryKeyColumnInfo(tableInfos) != null ? getPrimaryKeyColumnInfo(tableInfos).getColumnName() : "");
        mapperData.put("WhereId", "#{" + (getPrimaryKeyColumnInfo(tableInfos) != null ? getPrimaryKeyColumnInfo(tableInfos).getPropertyName() : "") + "}");
