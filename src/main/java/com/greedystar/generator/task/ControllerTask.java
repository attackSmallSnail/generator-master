...
public class ControllerTask extends AbstractTask {
    ...
    public void run() throws IOException, TemplateException {
        ...
        controllerData.put("VoPackageName", ConfigUtil.getConfiguration().getPath().getVo());
        controllerData.put("ReqPackageName", ConfigUtil.getConfiguration().getPath().getReq());
